...
namespace SimpleSharing
{
	public sealed class Behaviors
	{
		...
		public static Sync Update(Sync sync, string by, DateTime? when, bool deleteItem)
		{
			...
			// Removes all conflicts previously generated by the same endpoint
			updated.Conflicts.RemoveAll(delegate(Item conflict) { 
				return conflict.Sync.LastUpdate.By.Equals(by);
			});
